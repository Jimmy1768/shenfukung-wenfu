...
module Payments
  class CashPaymentRecorder
    ...
    def validate_settlement!
      ...
      # Same gate as online checkout (Temple#payment_settlement_frozen?):
      ...
      raise SettlementError, "Cash settlement is not available right now" if registration.temple.payment_settlement_frozen?
    end
