...
**Status: dormant.** This repository is Claude-exclusive as of 2026-08-18 —
see `ops/protocol/claude_work_mode.md`. Codex Work Mode below is not in
active use here; kept in case that changes, not as live governance.
